...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static final String API_KEY = "29ef38c1f420462384f6d7f9cc965bf4";
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() && response.body().getArticle() != null){
                    ...
                    showErrorMessage(errorImage, "No result", "Please try Again\n" + errorCode);
                }
            }
            ...
            public void onFailure(Call<News> call, Throwable t) {
                swipeRefreshLayout.setRefreshing(false);
                showErrorMessage(errorImage, "Oops...", "Network failure, Please Try Again\n" + t.toString());
            }
        });
    }
    ...
    private void showErrorMessage(ImageView imageView, String title, String message){
